$(function () {
    ...
    function init(pageNumber) {
        Core.postAjax("/suk/blog/api/comments", {
            "sid": sid,
            ...
            if (data.list.length == 0) {
                ...
                $(".reply").click(function () {
                    ...
                    $("#submitReplyCommentBtn").on('click', function () {
                        ...
                        Core.postAjax("/suk/blog/api/comment/save", $("#reply-comment-form").serialize(), function (data) {
                ...
                $(".comment-support").click(function () {
                    $thisLove = $(this);
                    Core.postAjax("/suk/blog/api/love", {
    ...
    $("#submitCommentBtn").click(function () {
        ...
        Core.postAjax("/suk/blog/api/comment/save", $("#comment-form").serialize(), function (data) {
            layer.msg(data.msg, {
                offset: '30%',
                time: 800
            }, function () {
